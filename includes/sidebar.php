<nav class="col-md-2 d-none d-md-block sidebar shadow-sm p-3">
    ...
    <ul class="nav flex-column gap-2">
        ...
        <!-- ເພີ່ມເມນູລົດທົວບ່ອນນີ້ -->
        <li class="nav-item">
            <a class="nav-link text-dark" href="<?php echo BASE_URL; ?>pages/vehicles/index.php">
                <i class="fas fa-bus me-2 text-info"></i> ລົດທົວ
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link text-dark" href="<?php echo BASE_URL; ?>pages/customers/index.php">
                <i class="fas fa-users me-2 text-success"></i> ຈັດການລູກຄ້າ
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link text-dark" href="<?php echo BASE_URL; ?>pages/bookings/index.php">
                <i class="fas fa-calendar-check me-2 text-primary"></i> ລາຍການຈອງ
            </a>
        </li>
        <li class="nav-item">
