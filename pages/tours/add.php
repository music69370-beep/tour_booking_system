            ...
            <form action="save.php" method="POST" enctype="multipart/form-data">
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="tour_name" class="form-control bg-light border-0 shadow-none" required>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label fw-bold small">ລາຄາຂາຍ / ຄົນ</label>
                        <input type="number" name="price" class="form-control bg-light border-0 shadow-none" placeholder="0" required>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label fw-bold small text-danger">ຕົ້ນທຶນ (Cost) / ຄົນ</label>
                        <input type="number" name="cost_per_person" class="form-control bg-white border-danger shadow-none" placeholder="0" required>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        <label class="form-label fw-bold small text-success">ຮູບພາບອື່ນໆປະກອບ (Gallery)</label>
                        <input type="file" name="gallery[]" class="form-control bg-light border-0 shadow-none" accept="image/*" multiple>
                    </div>
                    <div class="col-md-12">
                        <label class="form-label fw-bold small">ແຜນການເດີນທາງ</label>
                        <textarea name="itinerary" class="form-control bg-light border-0 shadow-none" rows="4"></textarea>
                    </div>
                    <div class="col-md-12">
                        <label class="form-label fw-bold small">ກິດຈະກຳຫຼັກ</label>
                        <textarea name="activities" class="form-control bg-light border-0 shadow-none" rows="2"></textarea>
                    </div>
...
function updateMaxSeats() {
    ...
    const capacity = select.options[select.selectedIndex].getAttribute('data-cap');
    seatsInput.value = capacity ? capacity : 0;
}
</script>
