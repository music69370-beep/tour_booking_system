    ...
    <div class="px-4 pb-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 no-print">
            ...
            <div class="d-flex gap-2">
                <?php if($row['status'] == 'Pending'): ?>
                    <button onclick="confirmApprove(<?php echo $id; ?>, 'approve.php')" class="btn btn-success rounded-pill px-4 shadow-sm">
                        <i class="fas fa-check-circle me-1"></i> ອະນຸມັດການຈອງ
                    </button>
                <?php endif; ?>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                ...
                <div class="card border-0 shadow-sm rounded-4 mb-4">
                    <div class="card-body p-4 text-start">
                        <div class="d-flex justify-content-between border-bottom pb-3 mb-4">
                            ...
                            <span class="badge rounded-pill px-3 py-2 <?php echo ($row['status']=='Confirmed')?'bg-success text-white':'bg-warning text-dark'; ?>">
                                <?php echo ($row['status']=='Confirmed')?'Confirmed':'Pending'; ?>
                            </span>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6 ps-md-4">
                                <h6 class="fw-bold text-primary mb-2"><i class="fas fa-map-marker-alt me-1"></i> ລາຍລະອຽດ:</h6>
                                <p class="small mb-1">ນັດພົບ: <strong><?php echo $row['meeting_point']; ?></strong></p>
                    ...
                    <div class="card-body p-4 pt-2">
                        <table class="table table-sm align-middle">
                            <thead class="bg-light">
                                <tr><th class="ps-3" width="50">#</th><th>ຊື່ ແລະ ນາມສະກຸນ</th><th>ເບີໂທລະສັບ</th></tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class="ps-3">1</td>
                                    <td><strong><?php echo $row['fullname']; ?></strong> <small class="text-muted">(ຫົວໜ້າ)</small></td>
                ...
                <!-- *** ຍ້າຍ Checklist ຄວາມພ້ອມ ມາໄວ້ບ່ອນນີ້ *** -->
                    ...
                    <div class="row" id="taskList">
                        ...
                        <?php endwhile; else: ?>
                            <div class="col-12 text-center">
                                <a href="init_tasks.php?id=<?php echo $id; ?>" class="btn btn-sm btn-outline-primary rounded-pill">ສ້າງລາຍການວຽກເລີ່ມຕົ້ນ</a>
                            </div>
                        <?php endif; ?>
                    </div>
            ...
            <!-- ເບື້ອງຂວາ (Summary & Resource) - 4/12 -->
            <div class="col-lg-4">
                
                <!-- 4. ສະຫຼຸບການເງິນ (Admin) -->
                <div class="card border-0 shadow-sm rounded-4 p-4 mb-4 bg-dark text-white">
                    <h6 class="fw-bold border-bottom border-secondary pb-2 mb-3 text-uppercase small">ສະຫຼຸບການເງິນ (Admin Only)</h6>
                    <div class="d-flex justify-content-between mb-2">
                        <small class="opacity-75">ຍອດຂາຍລວມ:</small>
                        <span class="fw-bold text-white"><?php echo number_format($total_sale); ?></span>
                    </div>
                    <div class="d-flex justify-content-between mb-2">
                ...
                <div class="card border-0 shadow-sm rounded-4 p-4 mb-4 bg-white">
                    <h6 class="fw-bold text-dark border-bottom pb-2 mb-3"><i class="fas fa-shuttle-van me-2 text-warning"></i>ການຈັດສັນພາຫະນະ-ໄກ້</h6>
                    <div class="mb-3">
                        <small class="text-muted d-block small">ລົດທົວ:</small>
                        <p class="fw-bold mb-0 text-dark"><?php echo $row['car_model'] ?: 'ຍັງບໍ່ໄດ້ກຳນົດ'; ?></p>
                    ...
                    <div>
                        ...
                        <small class="text-muted"><?php echo $row['guide_phone']; ?></small>
                    </div>
                </div>

                <!-- 6. ຫຼັກຖານການໂອນ (ສຳຄັນ) -->
                <div class="card border-0 shadow-sm rounded-4 p-4 mb-4 bg-white no-print">
                    <h6 class="fw-bold text-dark border-bottom pb-2 mb-3"><i class="fas fa-file-invoice-dollar me-2 text-success"></i>ຫຼັກຖານການຊຳລະ</h6>
                    <?php if($row['payment_slip']): ?>
                        <div class="text-center">
                            <a href="<?php echo BASE_URL; ?>assets/uploads/payments/<?php echo $row['payment_slip']; ?>" target="_blank">
                                <img src="<?php echo BASE_URL; ?>assets/uploads/payments/<?php echo $row['payment_slip']; ?>" class="img-fluid rounded-3 shadow-sm border" style="max-height: 250px; width: 100%; object-fit: contain;">
                            </a>
                            <div class="text-start mt-3 p-3 bg-light rounded-3 small">
                                <p class="mb-1">ວິທີຈ່າຍ: <strong><?php echo $row['payment_method']; ?></strong></p>
                                <p class="mb-0">ວັນທີຈ່າຍ: <strong><?php echo date('d/m/Y H:i', strtotime($row['payment_date'])); ?></strong></p>
                            </div>
                        </div>
                    <?php else: ?>
...
<script>
// Logic Toggle Task (AJAX) - ຍັງຄົງຮັກສາໄວ້ຄືເກົ່າ
...
<style>
    ...
    @media print { .sidebar, .no-print, nav { display: none !important; } .main-content { margin-left: 0 !important; width: 100% !important; padding: 0 !important; background: white !important; } .card { border: 1px solid #eee !important; box-shadow: none !important; } }
</style>
