    ...
    <div class="px-4 pb-5">
        <div class="d-flex justify-content-between align-items-center pt-3 pb-2 mb-4 border-bottom">
            ...
            <div class="d-flex gap-2">
                <a href="export.php" class="btn btn-success rounded-pill px-3 shadow-sm"><i class="fas fa-file-excel me-1"></i> Excel</a>
                                ...
                                <td class="text-center">
                                    <div class="btn-group shadow-sm border rounded-pill overflow-hidden">
                                        <?php if($status == 'Pending'): ?>
                                            <a href="javascript:void(0)" onclick="confirmApprove(<?php echo $booking_id; ?>, 'approve.php?status=<?php echo $status_filter; ?>')" class="btn btn-sm btn-white text-success border-end"><i class="fas fa-check-circle"></i></a>
                                        <?php endif; ?>
