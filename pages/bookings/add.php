...
<main class="col-md-10 ms-sm-auto col-lg-10 px-md-4 main-content">
    <div class="pt-3 pb-2 mb-3 border-bottom">
        <h2 class="fw-bold">ສ້າງການຈອງທົວໃໝ່</h2>
    </div>
        ...
        <form action="save.php" method="POST">
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <select name="tour_id" id="tour_id" class="form-select" onchange="calculatePrice()" required>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="num_people" id="num_people" class="form-control" value="1" min="1" oninput="calculatePrice()" required>
                </div>
                <div class="col-md-8">
